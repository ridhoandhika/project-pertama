<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="@if (Request::segment(1)=='dashboard' ) active @endif"><a class="nav-link" href="{{ route('dashboard') }}">
                    <i class="far fa-square"></i> <span>Dashboard</span></a>
            </li>
            <li class="menu-header">Menu</li>
            <li class="dropdown 
          @if (Request::segment(1)=='konfigurasi' ) active @endif ">
            <a href=" #" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i>
                <span>Konfigurasi</span></a>
                <ul class="dropdown-menu">
                    <li class=" @if (Request::segment(1)=='konfigurasi' and
            ...
            <li class="dropdown 
            @if (Request::segment(1)=='master-data' ) active @endif ">
            <!--<li class=" nav-item dropdown ">-->
                <a href=" #" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i>
                <span>Master Data</span></a>
                <ul class="dropdown-menu">
                    <li class=" @if (Request::segment(1)=='master-data' and
                        Request::segment(2)=='divisi' ) active @endif">
                        <a class="nav-link" href="{{ route('divisi.index') }}">Divisi</a>
                    </li>
                    <li><a class="nav-link" href="layout-top-navigation.html">Top Navigation</a></li>
                </ul>
            </li>
            <li class="@if (Request::segment(1)=='crud' ) active @endif"><a class="nav-link" href="{{ route('crud') }}">
                    <i class="far fa-square"></i> <span>CRUD</span></a>
            </li>
            {{-- <li class="nav-item dropdown">
